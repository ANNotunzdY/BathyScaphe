...
----------------------------------------
レス番号指定フィールドにフォーカスがある状態でスクロールすると
そのフォーカス・リングが画面上にゴミとして残ってしまう。
NSClipView の NSViewBoundsDidChangeNotification を受け取って
そこで View 全体を setKeyboardFocusRingNeedsDisplayInRect
してもいいが、パフォーマンスを稼ぐためここで対応する。
----------------------------------------
*/
//
